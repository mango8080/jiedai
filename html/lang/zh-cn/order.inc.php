<?php
/*
	[Hotel System] Copyright (c) 2016 QQ:59693566
	房客
*/
...
$L['group_title'] = '团购订单';
$L['group_sfields'] = array('按条件', '借款类型', '金额', '密码', '买家', '买家姓名', '买家地址', '买家邮编', '买家手机', '买家电话', '发货方式', '物流号码', '备注');
$L['group_order_title'] = '团购订单';
$L['group_order_sfields'] = array('按条件', '借款类型', '金额', '密码', '卖家', '发货方式', '物流号码', '备注');
...
$L['trade_status'] = array(
	'<span style="color:#008080;">等待审核</span>',
	'<span style="color:#FF6600;">审核通过</span>',
	'<span style="color:#0000FF;">已付款</span>',
	'<span style="color:#FF0000;">同意退款</span>',
	'<span style="color:#008000;">已入住</span>',
	'<span style="color:#FF0000;text-decoration:underline;">申请退款</span>',
	'<span style="color:#0000FF;text-decoration:underline;">已退款</span>',
	'<span style="color:#008080;">到店付款</span>',
	'<span style="color:#888888;text-decoration:line-through;">用户取消</span>',
	'<span style="color:#888888;text-decoration:line-through;">审核未通过</span>',
	'<span style="color:#888888;text-decoration:line-through;">已离店</span>',
	'<span style="color:#888888;text-decoration:line-through;">超时取消</span>',
);
...
$L['trade_pay_seller'] = '请填写收款用户名';
$L['trade_pay_self'] = '收款人不能是自己';
$L['trade_pay_seller_bad'] = '收款用户名不存在，请确认';
$L['trade_pay_amount'] = '请填写付款金额';
$L['trade_pay_note'] = '请填写付款说明';
$L['trade_pay_goods'] = '请填写房型或服务名称';
$L['trade_pay_title'] = '我要付款';
$L['trade_pay1_success'] = '直接付款成功，用户[{V0}]将直接收到您的付款';
$L['trade_pay0_success'] = '订单已经发出，请等待卖家确认';
$L['trade_order_sfields'] = array('按条件', '借款类型', '金额', '附加金额', '附加名称', '卖家', '发货方式', '物流号码', '备注');
$L['trade_order_title'] = '我的订单';
$L['trade_sfields'] = array('按条件', '借款类型', '金额', '附加金额', '附加名称', '买家', '买家姓名', '买家地址', '买家邮编', '买家手机', '买家电话', '发货方式', '物流号码', '备注');
$L['trade_title'] = '我的订单';
...
$L['purchase_msg_goods'] = '房型不存在';
$L['purchase_msg_self'] = '不能购买自己的房型';
$L['purchase_msg_group_finish'] = '团购已结束';
$L['purchase_msg_online_buy'] = '此房型不支持在线购买';
$L['post_free'] = '包邮';
...
$L['express_sfields'] = array('按条件', '房型名称', '快递公司', '快递单号');
