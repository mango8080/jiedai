...
用户ID:<input type="text" name="userid" value="<?php echo $userid;?>" size="5"/>&nbsp;
...
<div class="btns">
<input type="submit" value=" 删 除 " class="btn" onclick="if(confirm('确定要删除选中商友吗？此操作将不可撤销')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=delete'}else{return false;}"/>&nbsp;&nbsp;&nbsp;备注：用户ID代表商友的添加人(拥有者)
</div>
</form>
