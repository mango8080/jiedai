...
<div class="btns">
<input type="submit" value=" 解除绑定 " class="btn" onclick="if(confirm('确定要解除用户绑定吗？此操作将不可撤销')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=delete'}else{return false;}"/>&nbsp;
</div>
</form>
