...
require_once(DT_ROOT . '/include/getui/'.'IGt.Push.php');
require_once(DT_ROOT . '/include/getui/'.'igetui/IGt.AppMessage.php');
require_once(DT_ROOT . '/include/getui/'.'igetui/IGt.APNPayload.php');
require_once(DT_ROOT . '/include/getui/'.'igetui/template/IGt.BaseTemplate.php');
require_once(DT_ROOT . '/include/getui/'.'IGt.Batch.php');
require_once(DT_ROOT . '/include/getui/'.'igetui/utils/AppConditions.php');
...
define('APPKEY','x6bPEQyrCSA9AfHEfyOqW5');
define('APPID','HiFYOzLfEk7xEQl2F2BcZ9');
define('MASTERSECRET','okp6pnMuEz7cWjG1FgVKd3');
define('CID','d3a0fa512451d55415005b90ab19ab06');
define('DEVICETOKEN','');
define('Alias','请输入别名');
