...
$L['chat_msg_no_rights'] = '您所在的用户组没有权限发起对话';
$L['chat_msg_user'] = '用户不存在';
...
$L['friend_msg_add_again'] = '该用户已经是您的商友了';
$L['friend_msg_choose'] = '请选择商友';
$L['friend_sfields'] = array($L['search_by'], '姓名', '公司', '职位', '电话', '手机', '主页', 'Email', 'QQ', '阿里旺旺', 'MSN', 'Skype', '用户', $L['search_by_note']);

$L['grade_title'] = '用户升级';
$L['grade_fail'] = '您的用户组升级({V0})失败';
$L['grade_success'] = '您的用户组升级({V0})成功';
$L['grade_return'] = '升级失败返款';
$L['grade_upto'] = '升级为:';
$L['grade_pass_balance'] = '用户余额不足';
...
$L['member_username_match'] = '用户名为小写字母、数字组合';
$L['member_username_len'] = '用户登录名长度应在{V0}-{V1}之间';
$L['member_username_ban'] = '此登录名已经被禁止注册';
$L['member_username_reg'] = '用户登录名已经被注册';
...
$L['member_password_null'] = '用户登录密码不能为空';
...
$L['member_login_not_member'] = '用户不存在';
...
$L['member_rename_not_member'] = '当前用户名不存在';
...
$L['message_black_username'] = '请指定要加入黑名单的用户';
$L['message_black_not_member'] = '用户不存在，请检查';
$L['message_black_exist'] = '用户已经位于黑名单';
$L['message_black_update'] = '黑名单更新成功';
$L['message_pass_groupid'] = '请选择用户组';
...
$L['register_pass_groupid'] = '请选择用户组';
...
$L['send_check_username_bad'] = '您的用户名输入错误';
$L['send_check_password_bad'] = '您的用户名和密码不匹配';
$L['send_check_deny'] = '您的帐号无需发送验证信';
$L['send_check_mail'] = $DT['sitename'].'用户注册激活信';
$L['send_check_username_null'] = '您输入用户名不存在';
...
$L['style_msg_group'] = '抱歉！此模板未对您所在的用户组开放';
...
$L['type_names'] = array('friend'=>'商友', 'favorite'=>'收藏', 'product'=>'供应', 'mall'=>'借款类型', 'news'=>'新闻');
