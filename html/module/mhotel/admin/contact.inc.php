...
$sfields = array('按条件', '公司名', '用户名', '昵称','姓名', '部门', '职位', '手机号码','电话号码','传真号码', '详细地址', '邮政编码', '公司类型', '公司规模', '销售', '采购', '主营行业', '经营模式', 'Email', 'QQ', 'MSN', '阿里旺旺', 'Skype', '注册IP', '登录IP', '推荐人');
...
$sorder  = array('结果排序方式', '注册时间降序', '注册时间升序', '登录时间降序', '登录时间升序', '登录次数降序', '登录次数升序', '账户'.$DT['money_name'].'降序', '账户'.$DT['money_name'].'升序', '用户'.$DT['credit_name'].'降序', '用户'.$DT['credit_name'].'升序', '短信余额降序', '短信余额升序', VIP.'指数降序', VIP.'指数升序', '注册年份降序', '注册年份升序', '注册资本降序', '注册资本升序', '服务开始降序', '服务开始升序', '服务结束降序', '服务结束升序','浏览人气降序','浏览人气升序');
...
$order = $dorder[$order];
if($export) {
	$data = '用户ID,用户名,用户组,公司名,联系人,职位,性别,电话,手机,电子邮件,QQ,阿里旺旺,MSN,Skype,详细地址,邮编,注册时间,最后登录,登录次数,资金余额,积分余额,短信余额,'.VIP.'指数'."\n";
