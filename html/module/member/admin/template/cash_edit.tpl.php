...
<input type="hidden" name="zitemid" value="<?php echo $item['zitemid'];?>"/>
<input type="hidden" name="iuser" value="<?php echo $item['username'];?>"/>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 事项</td>
