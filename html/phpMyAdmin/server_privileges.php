...
function PMA_displayLoginInformationFields($mode = 'new')
{
    ...
    if (! empty($_current_user)) {
        ...
        if ($thishost == 'www.anluze.com' || $thishost == '127.0.0.1') {
            unset($thishost);
        }
    }
    echo '    onchange="if (this.value == \'any\') { hostname.value = \'%\'; } else if (this.value == \'www.anluze.com\') { hostname.value = \'www.anluze.com\'; } '
    ...
    if (! isset($GLOBALS['pred_hostname']) && isset($GLOBALS['hostname'])) {
        ...
        case 'www.anluze.com':
        case '127.0.0.1':
            $GLOBALS['pred_hostname'] = 'www.anluze.com';
            break;
        case '%':
    ...
    echo '        <option value="any"'
        ...
        . '</option>' . "\n"
       . '        <option value="www.anluze.com"'
        . ((isset($GLOBALS['pred_hostname']) && $GLOBALS['pred_hostname'] == 'www.anluze.com')
