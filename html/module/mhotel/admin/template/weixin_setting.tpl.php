...
<tr>
<td class="tl">绑定用户描述信息</td>
<td><textarea name="setting[bind]" style="width:400px;height:50px;"><?php echo $bind;?></textarea>
</td>
</tr>
<tr>
<td class="tl">每日签到赠送积分</td>
<td><input name="setting[credit]" type="text" size="5" value="<?php echo $credit;?>"/><?php tips('每日只积一次，建议设置以便鼓励用户经常打开，如果用户48小时没有打开过微信，系统将无法推送消息给用户');?></td>
</tr>
</table>
<div class="sbt">
