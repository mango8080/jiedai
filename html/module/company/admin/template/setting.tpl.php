...
<option value="userid desc"<?php if($order == 'userid desc') echo ' selected';?>>用户ID</option>
</select>
</td>
</tr>
<tr>
...
<?php tips('如果选择开启，服务到期之后，系统自动将'.VIP.'用户设置成普通用户<br/>如果选择关闭，服务到期之后，用户可以继续使用'.VIP.'服务，需要管理员从过期'.VIP.'里手动删除');?>
</td>
</tr>
<tr>
