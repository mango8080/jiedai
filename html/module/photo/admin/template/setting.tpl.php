...
<td><input type="text" size="3" name="setting[swfu_max]" value="<?php echo $swfu_max;?>"/> <?php tips('此项仅针对前台用户上传，-1表示禁止批量传图，0表示单次上传不限制数量，具体数字表示单次上传限制的图片数量<br/>注意：此功能在用户模块绑定二级域名的情况下将不可用');?></td>
</tr>
