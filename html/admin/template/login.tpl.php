...
<td>
	<div class="msg">
		...
		<tr>
		<td colspan="2" height="50"><a href="http://www.idc580.cn/" target="_blank"><img src="admin/image/spacer.gif" width="290" height="30" title="Powered By www.idc580.cn" alt=""/></a></td>
		</tr>
		<tr>
	...
	<div style="margin:10px 40px 0 40px;border:#FF8D21 1px solid;background:#FFFFDD;padding:8px;display:none;" id="tips"><img src="admin/image/notice.gif" align="absmiddle"/> 提示：为了系统安全，请尽快修改后台地址 &nbsp;<a href="http://www.idc580.cn/doc/use/34.html" target="_blank" style="color:#006699;">帮助&#187;</a></div>
