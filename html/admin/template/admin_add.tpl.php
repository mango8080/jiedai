...
&nbsp;&nbsp;<a href="javascript:if(Dd('username').value)_user(Dd('username').value);" class="t" title="点击查看填写用户的详细资料">[资料]</a>
&nbsp;&nbsp;<a href="?moduleid=2&action=add" class="t" target="_blank" title="如果用户还没有注册，请点这里添加">[添加]</a>
