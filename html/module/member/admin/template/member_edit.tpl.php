...
<tr>
<td class="tl"><span class="f_hid">*</span> 用户头像</td>
<td><img src="<?php echo useravatar($username, 'large');?>" style="margin:6px;" width="128" height="128"/></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 用户登录名</td>
<td><strong><?php echo $username;?></strong>&nbsp;&nbsp;<a href="?moduleid=<?php echo $moduleid;?>&username=<?php echo urlencode($username);?>&catid=1#editusername" class="t">[修改用户名]</a></td>
</tr>
...
<td><?php echo group_select('member[groupid]', '用户组', $groupid, 'id="groupid"');?>&nbsp;<span id="dgroupid" class="f_red"></span></td>
</tr>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 工作单位</td>
<td><input type="text" size="30" name="member[danwei]" id="trade" value="<?php echo $danwei;?>"/>&nbsp;</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 警种</td>
<td>
	
	<select name="member[jingzhong]" id="jingzhong">
                <option value="">选择警种</option>
                <option value="治安警察" {if $jingzhong=='治安警察'}selected{/if}>治安警察</option>
                <option value="综合警察" {if $jingzhong=='综合警察'}selected{/if}>综合警察</option>
                <option value="刑事犯罪侦查警察" {if $jingzhong=='刑事犯罪侦查警察'}selected{/if}>刑事犯罪侦查警察</option>
                <option value="交通警察" {if $jingzhong=='交通警察'}selected{/if}>交通警察</option>
                <option value="巡逻警察" {if $jingzhong=='巡逻警察'}selected{/if}>巡逻警察</option>
                <option value="外事警察" {if $jingzhong=='外事警察'}selected{/if}>外事警察</option>
                <option value="经济犯罪侦查警察" {if $jingzhong=='经济犯罪侦查警察'}selected{/if}>经济犯罪侦查警察</option>
                <option value="公共信息网络安全监察专业警察" {if $jingzhong=='公共信息网络安全监察专业警察'}selected{/if}>公共信息网络安全监察专业警察</option>
                <option value="禁毒警察" {if $jingzhong=='禁毒警察'}selected{/if}>禁毒警察</option>
                <option value="监所警察" {if $jingzhong=='监所警察'}selected{/if}>监所警察</option>
                <option value="警务督察" {if $jingzhong=='警务督察'}selected{/if}>警务督察</option>
                <option value="科技警察" {if $jingzhong=='科技警察'}selected{/if}>科技警察</option>
                <option value="公安法医" {if $jingzhong=='公安法医'}selected{/if}>公安法医</option>
...
<div class="tt"><span class="f_hid">*</span> 酒店资料</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl"><span class="f_red">*</span> 酒店名称</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 折扣比例</td>
<td><input type="text" size="60" name="member[zhekou]" id="zhekou" value="<?php echo $zhekou;?>"/>例：0.8，则表示酒店给平台的是八折</td> 
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 酒店类型</td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 酒店规模</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 酒店成立年份</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 酒店地址</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 酒店电话</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 酒店介绍</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 对民警优惠政策</td>
<td><textarea name="member[policies]" id="policies" style="width: 367px; height: 102px;"><?php echo $policies;?></textarea></td>
</tr>
...
<?php tips('一般由第三方认证机构或网站对用户总体资料的认证');?><a name="vv"></a>
</td>
</tr>
<tr>
...
<?php tips('一般在用户提现之后，由网站进行付款认证，认证之后用户的收款信息将不可修改');?>
</td>
</tr>
<tr>
...
<?php tips('一般由用户在线提交身份证或其他证件电子文档或传真件，由网站进行认证');?>
</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 酒店认证</td>
<td>
...
<?php tips('一般由用户在线提交营业执照、组织机构代码证等电子文档或传真件，由网站进行认证');?>
</td>
</tr>
</table> -->
<?php endif ?>
...
<td><input type="text" size="30" name="member[domain]" id="domain" value="<?php echo $domain;?>"/><?php tips('例如 www.idc580.cn 不带http<br/>同时需要用户将此域名IP指向本站服务器');?></td>
</tr>
<tr>
...
<td><input type="text" size="20" name="member[support]" id="support" value="<?php echo $support;?>"/> <a href="javascript:_user(Dd('support').value);" class="t">[资料]</a> <?php tips('填写客服用户名，填写后用户可以看到此客服的联系方式，以便提供一对一服务');?></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 推荐注册人 </td>
<td><input type="text" size="20" name="member[inviter]" id="inviter" value="<?php echo $inviter;?>"/> <a href="javascript:_user(Dd('inviter').value);" class="t">[资料]</a> <?php tips('推荐此用户注册的用户名，系统自动记录，一般无须填写');?></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 用户资料是否完整</td>
<td>
...
<span class="f_gray">如果选择是，系统将不再提示用户完善资料</span>
</td>
</tr>
</table> -->
...
function Dcheck() {
	...
	if(Dd('regyear').value.length < 4) {
		Dmsg('请填写酒店成立年份', 'regyear');
		return false;
	}
	if(Dd('address').value.length < 2) {
		Dmsg('请填写酒店地址', 'address');
		return false;
	}
	if(Dd('telephone').value.length < 6) {
		Dmsg('请填写酒店电话', 'telephone');
		return false;
	}
	if(FCKLen('content') < 10) {
		Dmsg('酒店介绍最少10字，当前已经输入'+FCKLen('content')+'字', 'content');
		return false;
	}
	<?php } ?>
	return true;
