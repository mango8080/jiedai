...
class brand {
    ...
    function __construct($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','level','title','style','fee','introduce','areaid','thumb','homepage','status','hits','username','addtime','adddate','editor','edittime','editdate','ip','template', 'linkurl','filepath','note','company','truename','telephone','mobile','address','email','msn','qq','ali','skype','zhengce');
    }
	...
	function set($post) {
		...
		$post['zhengce'] = stripslashes($post['zhengce']);
