...
<tr>
<td class="tl"><span class="f_hid">*</span> 用户组</td>
...
<?php if($user && $fee) { ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 用户组年费</td>
...
<?php } ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 用户已支付</td>
<td class="f_blue"><?php echo $amount;?> <?php echo $DT['money_unit'];?></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 需支付金额</td>
<td class="f_blue"><input type="text" name="post[pay]" size="5" value="<?php echo $pay;?>"/> <?php echo $DT['money_unit'];?>&nbsp;&nbsp;&nbsp;<a href="?moduleid=2&file=record&action=add&username=<?php echo $username;?>" class="t" target="_blank">[<?php echo $DT['money_name'];?>管理]</a>&nbsp;&nbsp;<span class="f_gray">(用户当前账户余额:<?php echo $user['money'];?><?php echo $DT['money_unit'];?>)</span></td>
</tr>
<tr>
...
<td class="f_gray">
- 如果通过申请，系统会尝试扣除需支付金额，如果用户余额不足，将操作失败<br/>
- 如果拒绝申请，系统会返还用户已支付的金额<br/>
</td>
</tr>
</table>
