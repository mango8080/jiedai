...
<tr>
<td class="tl">用户名： </td>
<td><input type="text" name="username" size="20" id="username"/> &nbsp; <input type="submit"  value=" 删除 " class="btn"/> <span id="dusername" class="f_red"></span>&nbsp;&nbsp;<span class="f_gray">删除用户的所有上传文件</span>
</td>
</tr>
</table>
</form>
...
function Dcheck() {
	...
	return confirm('确定要删除用户 '+Dd(f).value+' 的所有上传文件吗？此操作不可撤销');
}
function Dfind() {
	var l;
	var f;
