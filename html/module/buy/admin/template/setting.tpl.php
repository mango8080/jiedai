...
<td>
<input type="radio" name="setting[captcha_price]" value="2"  <?php if($captcha_price == 2) echo 'checked';?>> 继承用户组设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td>
<input type="radio" name="setting[question_price]" value="2"  <?php if($question_price == 2) echo 'checked';?>> 继承用户组设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
