...
$RT['action']['index']['add'] = '用户添加';
$RT['action']['index']['edit'] = '用户修改';
$RT['action']['index']['delete'] = '用户删除';
$RT['action']['index']['check'] = '用户审核';
$RT['action']['index']['move'] = '用户移动';
$RT['action']['index']['show'] = '用户查看';

$RT['action']['group']['add'] = '用户组添加';
$RT['action']['group']['edit'] = '用户组修改';
$RT['action']['group']['delete'] = '用户组删除';
