...
<tr>
<td class="tl"><span class="f_red">*</span> 用户登录名</td>
...
<td><input type="text" size="80" name="member[business]" id="business" value="酒店宾馆" />&nbsp;<span id="dbusiness" class="f_red"></span></td>
</tr> -->
<!-- <tr>
...
<td><input type="text" size="15" name="member[regyear]" id="regyear" value="2010" />&nbsp;<span id="dregyear" class="f_red"></span> <span class="f_gray">(年份，如：2004)</span></td>
</tr>
<tr>
...
<td><textarea name="member[policies]" id="policies" style="width: 367px; height: 102px;">优惠政策</textarea>
</tr>
...
function Dcheck() {
	if(Dd('username').value == '') {
		Dmsg('请填写用户登录名', 'username');
		return false;
	}
	if(Dd('password').value == '') {
		Dmsg('请填写用户登录密码', 'password');
		return false;
	}
