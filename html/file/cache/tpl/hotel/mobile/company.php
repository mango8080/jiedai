...
<h1 class="f-16 b" style="font-size:16px;"><span><?php echo $cityName;?>(<?php echo $items;?>)</span></h1>
<a href="../mobile" class="home"><img src="static/images/home.png" height="21px"/></a>
</header>
<div class="hotel_list">
    <div class="top" style="display:none;">
     <div class="chead">
            <a id="district"><span><?php echo $cityName;?>(<?php echo $items;?>)</span></a>
    ...
    <div class="b_box clearfix">
            <p id="checkInDate" class="date input-group" data-date-format="dd MM yyyy" data-link-format="yyyy-mm-dd" data-date=""  data-link-field="dtp_input2" onclick="this.isclick=1">
                ...
                <input id="dtp_input2" value="<?php echo $beginDate;?>" readonly type="hidden">
            ...
            <p id="checkOutDate" class="date input-group" data-date-format="dd MM yyyy" data-link-format="yyyy-mm-dd" data-date=""  data-link-field="dtp_input3">
                ...
                <input id="dtp_input3" value="<?php echo $endDate;?>" readonly type="hidden">
...
<?php if($toplists) { ?>
<?php if(is_array($toplists)) { foreach($toplists as $v) { ?>
<li class="clearfix">
<a href="index.php?moduleid=<?php echo $moduleid;?>&username=<?php echo $v['username'];?>&beginDate=<?php echo $beginDate;?>&endDate=<?php echo $endDate;?>&roomNum=<?php echo $roomNum;?>" class="b f-16 clearfix">
<img src="<?php if($v['thumb']) { ?><?php echo $v['thumb'];?><?php } else { ?>static/imgpic-60.png<?php } ?>
" alt="" width="74" height="74" onerror="this.src='static/images/default_small.png'" class="logoImg">
<p class="title"><?php echo $v['company'];?> </p>
<div class="left">
<p></p>
<p class="clearfix">
...
<!-- <p style="padding: 3px 0;"><img alt="" src="static/images.png" width="13" style="margin-right: 5px"><span><?php echo $v['jlf'];?><?php echo $v['jlu'];?></span></p> -->
<p style="padding: 3px 0;"><img alt="" src="static/images.png" width="13" style="margin-right: 5px"><span><?php if($wtype=="10") { ?>距离&nbsp;<font color="#FF8E7E"><?php echo $wd;?></font>&nbsp;<?php } ?>
<?php echo $v['jlf'];?><?php echo $v['jlu'];?></span></p>
</div>
<div class="jiage">
<span>￥</span><span><?php echo $v['lowprice'];?></span>起
</div>
</a>
</li>
<?php } } ?>
...
<input type="hidden" id="nowpage" value="<?php echo $page;?>"/>
<input type="hidden" id="nexturl" value="index.php?moduleid=<?php echo $moduleid;?>&beginDate=<?php echo $beginDate;?>&endDate=<?php echo $endDate;?>&roomNum=<?php echo $roomNum;?>"/>
<input type="hidden" id="wtype" value="<?php echo $wtype;?>"/>
<input type="hidden" id="wd" value="<?php echo $wd;?>"/>
<div class="big">
<div class="model">
<div class="message">
正在加载。。。
...
var searchflag="";
if ($("#wtype").val()=="10") searchflag='距离&nbsp;<font color="#FF8E7E">'+$("#wd").val()+'</font>&nbsp;';
...
$.ajax({
    ...
    var result = '';
        ...
        +'</p>'
        +'<p style="padding: 3px 0;"><img src="static/images/db.png" width="13" style="margin-right: 5px"><span>'+searchflag+data.data[i].jlf+data.data[i].jlu+'</span></p>'
        +'</div>'        
        +'<div class="jiage">'
...
<script type="text/javascript">
    ...
    localStorage.com = location.href;
}
</script> 
