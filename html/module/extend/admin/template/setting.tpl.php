...
<td><input name="setting[mobile_domain]" type="text" size="30" value="<?php echo $mobile_domain;?>"/><?php tips('例如 http://m.idc580.cn/<br/>请将此域名绑定至网站mobile目录');?></td>
</tr>
<tr> 
...
<td><input name="setting[spread_domain]"  type="text" size="30" value="<?php echo $spread_domain;?>"/><?php tips('例如 http://spread.idc580.cn/<br/>请将此域名绑定至网站spread目录');?></td>
</tr>
<tr> 
...
<td><input name="setting[ad_domain]"  type="text" size="30" value="<?php echo $ad_domain;?>"/><?php tips('例如 http://ad.idc580.cn/<br/>请将此域名绑定至网站ad目录');?></td>
</tr>
<tr>
...
<td><input name="setting[announce_domain]"  type="text" size="30" value="<?php echo $announce_domain;?>"/><?php tips('例如 http://announce.idc580.cn/<br/>请将此域名绑定至网站announce目录');?></td>
</tr>
</table>
...
<td><input name="setting[link_domain]"  type="text" size="30" value="<?php echo $link_domain;?>"/><?php tips('例如 http://link.idc580.cn/<br/>请将此域名绑定至网站link目录');?></td>
</tr>
<tr>
...
<td><input name="setting[comment_domain]"  type="text" size="30" value="<?php echo $comment_domain;?>"/><?php tips('例如 http://comment.idc580.cn/<br/>请将此域名绑定至网站comment目录');?></td>
</tr>
<tr>
...
<tr>
<td class="tl">允许评论的用户组</td>
<td><?php echo group_checkbox('setting[comment_group][]', $comment_group);?></td>
</tr>
<tr>
<td class="tl">允许支持反对的用户组</td>
<td><?php echo group_checkbox('setting[comment_vote_group][]', $comment_group);?></td>
</tr>
<tr>
<td class="tl">审核评论</td>
<td>
<input type="radio" name="setting[comment_check]" value="2"  <?php if($comment_check == 2) echo 'checked';?>> 继承用户组设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td>
<input type="radio" name="setting[comment_captcha_add]" value="2"  <?php if($comment_captcha_add == 2) echo 'checked';?>> 继承用户组设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td><input name="setting[guestbook_domain]"  type="text" size="30" value="<?php echo $guestbook_domain;?>"/><?php tips('例如 http://guestbook.idc580.cn/<br/>请将此域名绑定至网站guestbook目录');?></td>
</tr>
<tr> 
<td class="tl">留言类型</td>
...
<td><input name="setting[gift_domain]"  type="text" size="30" value="<?php echo $gift_domain;?>"/><?php tips('例如 http://gift.idc580.cn/<br/>请将此域名绑定至网站gift目录');?></td>
</tr>
</table>
...
<td><input name="setting[vote_domain]"  type="text" size="30" value="<?php echo $vote_domain;?>"/><?php tips('例如 http://vote.idc580.cn/<br/>请将此域名绑定至网站vote目录');?></td>
</tr>
</table>
...
<td><input name="setting[poll_domain]"  type="text" size="30" value="<?php echo $poll_domain;?>"/><?php tips('例如 http://poll.idc580.cn/<br/>请将此域名绑定至网站poll目录');?></td>
</tr>
</table>
...
<td><input name="setting[form_domain]"  type="text" size="30" value="<?php echo $form_domain;?>"/><?php tips('例如 http://form.idc580.cn/<br/>请将此域名绑定至网站form目录');?></td>
</tr>
</table>
...
<td><input name="setting[archiver_domain]"  type="text" size="30" value="<?php echo $archiver_domain;?>"/><?php tips('例如 http://archiver.idc580.cn/<br/>请将此域名绑定至网站archiver目录');?></td>
</tr>
</table>
...
<td><input name="setting[feed_domain]"  type="text" size="30" value="<?php echo $feed_domain;?>"/><?php tips('例如 http://feed.idc580.cn/<br/>请将此域名绑定至网站feed目录');?></td>
</tr>
<tr> 
