...
用户名：<input type="text" name="username" value="<?php echo $username;?>" size="8"/>&nbsp;
用户ID：<input type="text" name="uid" value="<?php echo $uid;?>" size="4"/>
</td>
</tr>
</table>
</form>
<div class="tt">联系用户</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<th>公司</th>
<th>姓名</th>
...
<tr onmouseover="this.className='on';" onmouseout="this.className='';" align="center" title="用户名:<?php echo $v['username'];?>&#10;用户ID:<?php echo $v['userid'];?>&#10;用户组:<?php echo $GROUP[$v['groupid']]['groupname'];?>">
...
<td>
<a href="javascript:_user('<?php echo $v['username'];?>')"><img src="admin/image/view.png" width="16" height="16" title="用户[<?php echo $v['username'];?>]详细资料" alt=""/></a> 
<a href="?moduleid=<?php echo $moduleid;?>&action=login&userid=<?php echo $v['userid'];?>" target="_blank"><img src="admin/image/set.png" width="16" height="16" title="进入用户商务中心" alt=""/></a> 
</td>
</tr>
<?php }?>
</table>
