...
<td>可以通过此功能将用户的未读站内信发送至其注册邮箱</td>
</tr>
<tr>
...
<div class="sbt"><input type="submit" name="submit" value=" 开始发送 " class="btn" onclick="if(!confirm('确定发送超过 '+Dd('hour').value+' 小时未读的站内信至用户信箱吗？')) return false;"></div>
</form>
