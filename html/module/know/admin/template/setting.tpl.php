...
<input type="radio" name="setting[answer_repeat]" value="0"  <?php if(!$answer_repeat) echo 'checked';?>/> 关闭 <?php tips('如果关闭，同一个用户或者IP只能回答一次');?>
</td>
</tr>
<tr>
...
<td>
<input type="radio" name="setting[check_answer]" value="2"  <?php if($check_answer == 2) echo 'checked';?>> 继承用户组设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td>
<input type="radio" name="setting[captcha_answer]" value="2"  <?php if($captcha_answer == 2) echo 'checked';?>> 继承用户组设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td>
<input type="radio" name="setting[question_answer]" value="2"  <?php if($question_answer == 2) echo 'checked';?>> 继承用户组设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
