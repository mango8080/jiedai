...
<td><input name="setting[sphinx_host]" type="text" size="20" value="<?php echo $sphinx_host;?>"/><?php tips('默认为www.anluze.com或者127.0.0.1，可留空');?></td>
</tr>
<tr>
...
<td>
<input type="radio" name="setting[captcha_inquiry]" value="2"  <?php if($captcha_inquiry == 2) echo 'checked';?>> 继承用户组设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td>
<input type="radio" name="setting[question_inquiry]" value="2"  <?php if($question_inquiry == 2) echo 'checked';?>> 继承用户组设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
